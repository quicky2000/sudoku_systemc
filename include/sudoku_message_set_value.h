...
*/
#ifndef SUDOKU_MESSAGE_SET_VALUE_H
#define SUDOKU_MESSAGE_SET_VALUE_H
...
namespace sudoku_systemc
{
  template<unsigned int SIZE>
    class sudoku_message_set_value: public sudoku_message_base<SIZE>
  {
  public:
    sudoku_message_set_value(const typename sudoku_types<SIZE>::t_group_type & p_vertical_group,
      ...
      sudoku_message_base<SIZE>(p_vertical_group,
				...
				typename sudoku_types<SIZE>::t_cmd_type((int)sudoku_message_base<SIZE>::t_cmd_message::SET_VALUE),
				p_value)
      {
      }
...
#endif // SUDOKU_MESSAGE_SET_VALUE_H
//EOP
