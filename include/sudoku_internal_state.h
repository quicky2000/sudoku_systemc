...
namespace sudoku_systemc
{
  template<unsigned int SIZE> 
    ...
    {
    public:
      sudoku_internal_state(const unsigned int & p_sub_x,const unsigned int & p_sub_y,const unsigned int & p_initial_value=0):
	...
	//TO DELETE  void remove_group_vertical_candidate(const sc_bv<sudoku_utils<SIZE*SIZE>::m_nb_bits_for_value> & p_value, const sc_bv<sudoku_utils<SIZE>::m_nb_bits_for_value> & p_sub_x)
	//TO DELETE  {
	...
	//TO DELETE  void remove_group_horizontal_candidate(const sc_bv<sudoku_utils<SIZE*SIZE>::m_nb_bits_for_value> & p_value, const sc_bv<sudoku_utils<SIZE>::m_nb_bits_for_value> & p_sub_x)
	//TO DELETE  {
	//TO DELETE    assert(p_value.to_uint());
	...
	unsigned int get_real_value(const typename sudoku_types<SIZE>::t_data_type & p_value)
	{
	...
	//TO DELETE  const typename sudoku_types<SIZE>::t_available_values & get_available_values(void)const
	//TO DELETE  {
