...
sudoku_message_release_value<SIZE>::sudoku_message_release_value(const typename sudoku_types<SIZE>::t_group_type & p_vertical_group,
...
//------------------------------------------------------------------------------
template<unsigned int SIZE>
void sudoku_message_release_value<SIZE>::be_treated(sudoku_message_analyser_if<SIZE> * p_analyser)const
{
  assert(p_analyser);
